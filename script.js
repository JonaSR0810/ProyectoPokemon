...
const options = {
  ...
  headers: {
    ...
    apikey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR5Z3J4bHJqbmV1dGVhcnVndWFrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjg1NDYxNjUsImV4cCI6MjA0NDEyMjE2NX0.wV6iwBGd7T4WznhRUJ6kKNTtpoMK1tmiicphWIkJhh8'
  }
};
...
fetch('https://dygrxlrjneutearuguak.supabase.co/rest/v1/pokemon?select=*', options)
